...
def main(args):
    ...
    if args.vae_model is not None or args.vae_ckpt is not None:
        ...
        # latents_bias = vae.vq_mean
        # latents_scale = vae.vq_std
        # vae_string_name = args.vae_model 
        # vae_1d = True
        vae, vae_string_name, vae_embed_dim, dit_input_size, latents_bias, latents_scale, vae_1d = build_tokenizer(args.vae_config, args.vae_ckpt)
    else:
    ...
    folder_name = f"{model_string_name}-{args.path_type}-vae{vae_string_name}-size-{args.resolution}" \
...
if __name__ == "__main__":
    ...
    parser.add_argument("--resolution", type=int, choices=[64, 256, 512], default=256)
