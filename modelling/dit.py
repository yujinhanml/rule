...
class Attention(nn.Module):
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        ...
        elif self.flash_attn and qkv.dtype != torch.float32 and flash_attn_qkvpacked_func is not None:
...
class DiT(nn.Module, PyTorchModelHubMixin):
    ...
    def __init__(
        ...
        patch_size=2,
        vae_1d=False,
        tags=["arxiv:2412.10958", "image-generation", "32 tokens", "DiT"], 
...
def DiT_SL_1(**kwargs):
    return DiT(depth=16, hidden_size=1024, patch_size=1, num_heads=16, **kwargs)
