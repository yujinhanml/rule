...
class SiT(nn.Module, PyTorchModelHubMixin):
    ...
    def __init__(
        ...
        use_cfg=False,
        vae_1d=False,
        tags=["arxiv:2412.10958", "image-generation", "32 tokens", "SiT"], 
    ...
    def forward(self, x, t, y, return_logvar=False, return_mid_feat=None):
        """
        Forward pass of SiT.
        ...
        return_mid = return_mid_feat is not None 

        zs = []
        for i, block in enumerate(self.blocks):
            x = block(x, c)  # (N, T, D)
            if return_mid and (i + 1) == return_mid_feat:
                return x
